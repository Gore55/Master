...
def create_ts(coord_mat):
    ...
    for i in range(0,d0):
        ...
        y[i] = coord_mat[TIME_STEPS + i + DELAY, 0:3]
    return x, y
...
def build_model():
    model = Sequential()
    model.add(LSTM(32,batch_input_shape=(BATCH_SIZE, TIME_STEPS, 3), 
...
script_path = r'C:\Users\jaime\Documents\Python\TFM\Scripts'
...
print(y_test_t_usc.shape,y_pred_usc.shape)
